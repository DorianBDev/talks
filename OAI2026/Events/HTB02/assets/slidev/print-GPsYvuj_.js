import{d as _,a4 as u,z as h,f as n,g as t,t as s,T as c,F as f,aj as g,o as l,i as v,e as x,ad as b}from"../modules/vue-nc2o2shR.js";import{a as y,u as N,x as m}from"../index-B3TdmGvl.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-CQyuPJE0.js";import"../modules/shiki-B7uncE0E.js";const T={id:"page-root"},w={class:"m-4"},L={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
